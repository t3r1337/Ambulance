...
{
    public partial class Orderlies : Form
    {
        public Orderlies()
        {
            InitializeComponent();
        ...
        private void Orderlies_Load(object sender, EventArgs e)
        {
            Connect("SELECT * FROM Orderlies");
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                using (SqlConnection connection = new SqlConnection(bd.connectionString))
                {
                    string sql = "DELETE FROM Orderlies WHERE ID='" + id + "'";
                    connection.Open();
        ...
        {
            OrderliesAddEdit ad = new OrderliesAddEdit();
            ad.options = "add";
            ad.Show();
        }
