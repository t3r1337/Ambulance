...
namespace Ambulance {
    ...
    [global::System.Xml.Serialization.XmlRootAttribute("DoctorsDS")]
    [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
    public partial class DoctorsDS : global::System.Data.DataSet {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        protected DoctorsDS(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : 
        ...
        public override global::System.Data.DataSet Clone() {
            DoctorsDS cln = ((DoctorsDS)(base.Clone()));
            cln.InitVars();
        ...
        private void InitClass() {
            this.DataSetName = "DoctorsDS";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/DoctorsDS.xsd";
        ...
        public partial class DoctorsDataTable : global::System.Data.TypedTableBase<DoctorsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public DoctorsRow AddDoctorsRow(string Фамилия, string Имя, string Отчество, int Специализация) {
        ...
        public partial class DoctorsRow : global::System.Data.DataRow {
            ...
            public string Отчество {
                get {
                    try {
                        return ((string)(this[this.tableDoctors.ОтчествоColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Отчество\' в таблице \'Doctors\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableDoctors.ОтчествоColumn] = value;
                }
            }
            ...
            public int Специализация {
                get {
                    return ((int)(this[this.tableDoctors.СпециализацияColumn]));
                }
                set {
            ...
            public bool IsОтчествоNull() {
                return this.IsNull(this.tableDoctors.ОтчествоColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetОтчествоNull() {
                this[this.tableDoctors.ОтчествоColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Ambulance.DoctorsDSTableAdapters {
    ...
    public partial class DoctorsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Doctors] WHERE (([ID] = @Original_ID) AND ([Фамилия] = @Original_Фамилия) AND ([Имя] = @Original_Имя) AND ((@IsNull_Отчество = 1 AND [Отчество] IS NULL) OR ([Отчество] = @Original_Отчество)) AND ([Специализация] = @Original_Специализация))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Doctors] ([Фамилия], [Имя], [Отчество], [Специализация]) VALUE" +
                "S (@Фамилия, @Имя, @Отчество, @Специализация);\r\nSELECT ID, Фамилия, Имя, Отчеств" +
                "о, Специализация FROM Doctors WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Doctors] SET [Фамилия] = @Фамилия, [Имя] = @Имя, [Отчество] = @Отчество, [Специализация] = @Специализация WHERE (([ID] = @Original_ID) AND ([Фамилия] = @Original_Фамилия) AND ([Имя] = @Original_Имя) AND ((@IsNull_Отчество = 1 AND [Отчество] IS NULL) OR ([Отчество] = @Original_Отчество)) AND ([Специализация] = @Original_Специализация));
SELECT ID, Фамилия, Имя, Отчество, Специализация FROM Doctors WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Фамилия, Имя, Отчество, Специализация FROM dbo.Doctors";
        ...
        public virtual int Fill(DoctorsDS.DoctorsDataTable dataTable) {
        ...
        public virtual DoctorsDS.DoctorsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DoctorsDS.DoctorsDataTable dataTable = new DoctorsDS.DoctorsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DoctorsDS.DoctorsDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DoctorsDS dataSet) {
        ...
        public virtual int Delete(int Original_ID, string Original_Фамилия, string Original_Имя, string Original_Отчество, int Original_Специализация) {
            ...
            this.Adapter.DeleteCommand.Parameters[5].Value = ((int)(Original_Специализация));
        ...
        public virtual int Insert(string Фамилия, string Имя, string Отчество, int Специализация) {
            if ((Фамилия == null)) {
        ...
        public virtual int Update(string Фамилия, string Имя, string Отчество, int Специализация, int Original_ID, string Original_Фамилия, string Original_Имя, string Original_Отчество, int Original_Специализация, int ID) {
            if ((Фамилия == null)) {
                throw new global::System.ArgumentNullException("Фамилия");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Фамилия, string Имя, string Отчество, int Специализация, int Original_ID, string Original_Фамилия, string Original_Имя, string Original_Отчество, int Original_Специализация) {
            return this.Update(Фамилия, Имя, Отчество, Специализация, Original_ID, Original_Фамилия, Original_Имя, Original_Отчество, Original_Специализация, Original_ID);
        }
    }
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateUpdatedRows(DoctorsDS dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._doctorsTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateInsertedRows(DoctorsDS dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._doctorsTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateDeletedRows(DoctorsDS dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._doctorsTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        public virtual int UpdateAll(DoctorsDS dataSet) {
            if ((dataSet == null)) {
